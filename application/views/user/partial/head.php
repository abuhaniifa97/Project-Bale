...
<head>
  ...
  <!-- plugins:css -->
  <link rel="stylesheet" href="<?php echo base_url('assets/user/vendors/feather/feather.css')?>">
  <link rel="stylesheet" href="<?php echo base_url('assets/user/vendors/ti-icons/css/themify-icons.css')?>">
  <link rel="stylesheet" href="<?php echo base_url('assets/user/vendors/css/vendor.bundle.base.css')?>">
  <!-- endinject -->
